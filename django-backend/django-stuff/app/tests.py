...
#         response = self.client.post("/api/posts/", {'user': 1,"name": "tesst", "title": "test_title", "description": "test_content", "s_date" : "2023-04-10", "e_date" : "2023-04-10", "s_time": "11:35:00", "e_time":"11:36:00",}, content_type= 'application/json')
